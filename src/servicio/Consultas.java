...
public class Consultas {
	...
	// CONSULTA DE SALDO 
	public static List<Object[]> saldoFila(Cuenta cuenta) {
	...
	public static List<Object[]> ultimosMovimientosFilas(Cuenta cuenta, int limite) {
		List<Object[]> filas = new ArrayList<>();
		if (cuenta == null) return filas;
	...
	public static List<Object[]> movimientosPorRangoFilas(Cuenta cuenta, String desde, String hasta) {
		List<Object[]> filas = new ArrayList<>();
		if (cuenta == null) return filas;
